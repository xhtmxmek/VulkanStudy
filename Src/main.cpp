...
#pragma region glfw(window framework)
private:
	void initWindow() {
		glfwInit();
...
#pragma region physicalDevice & draw queue families
private:
...
#pragma region LogicalDevice & queue
private:
...
#pragma region Presentation & swapchain
private:
	void createSurface()
	{
